...
public class MoodLightingHomeActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            if (backStack.size() >= 2) {
                backStack.pop();
                setCurrentFragment(backStack.pop());
            } else {
                super.onBackPressed();
            }
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mood_lighting_home, menu);
        return true;
    }
    ...
    public void setCurrentFragment(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.moodlighting_home_fragment, fragment);
